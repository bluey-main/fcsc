...
const Navbar = () => {
  ...
  return (
    <nav className="w-full  flex lg:flex-row flex-col justify-center items-center lg:px-10 lg:gap-y-0 gap-y-7 fixed top-0 z-50">
      ...
      >
        <ul className="p-6 rounded-lg lg:bg-transparent bg-customBlack  w-full lg:h-full flex justify-around lg:items-center lg:flex-row flex-col text-lg text-white lg:text-customBlack font-medium gap-y-5">
          <Link href={"/"}>
          ...
          <div className="lg:w-[20%] w-full h-full  flex lg:justify-center justify-start items-center">
            <Link href={"/contact"}>
              <div className="lg:w-[11rem] h-full w-[10rem]  text-white bg-customGreen flex p-5 justify-center items-center gap-x-3 rounded-2xl lg:text-lg text-base font-semibold">
                <p>Contact Us</p>
